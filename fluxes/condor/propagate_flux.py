...
def propagate_events(xsec_norm, flux_type, auto=False, gamma_factor='default'):
    ...
    outfile_name = f'/data/user/chill/icetray_LWCompatible/propagation_grid/output/nuSQuIDS_flux_cache_{xsec_norm}_{gamma_factor}_{flux_type}.hdf'
...
def main(xsec_norm, flux_type, gamma):
